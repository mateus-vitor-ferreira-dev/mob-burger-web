// ITU-T E.164 calling codes — ISO 3166-1 alpha-2 → dial code
const DIAL_CODES: Record<string, string> = {
  ...
  VA: '+379', VC: '+1',   VE: '+58',  VG: '+1',   VI: '+1',   VN: '+84',
  VU: '+678', WF: '+681', WS: '+685', YE: '+967', YT: '+262', ZA: '+27',
  ZM: '+260', ZW: '+263',
};
...
// Gera emoji de bandeira a partir do código ISO (ex: "BR" → 🇧🇷)
...
function buildCountries(): Country[] {
  ...
  try {
    ...
    // fallback: usa o código ISO como nome
  }
